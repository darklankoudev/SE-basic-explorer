...
// import MyComponent from "../../Css/icons/icon";
// // import Createii from "../../Css/icons/createicon";
            ...
            {/* <div className="h-screen relative loading-page loading-page--before-hide [&.loading-page--before-hide]:before:block [&.loading-page--hide]:before:opacity-0 before:content-[''] before:transition-opacity before:duration-300 before:hidden before:inset-0 before:h-screen before:w-screen before:fixed before:bg-gradient-to-b before:from-theme-1 before:to-theme-2 before:z-[60] [&.loading-page--before-hide]:after:block [&.loading-page--hide]:after:opacity-0 after:content-[''] after:transition-opacity after:duration-300 after:hidden after:h-16 after:w-16 after:animate-pulse after:fixed after:opacity-50 after:inset-0 after:m-auto after:bg-loading-puff after:bg-cover after:z-[61]"> */}
                <div className="side-menu xl:ml-0 shadow-xl transition-[margin,padding] duration-300 xl:shadow-none fixed top-0 left-0 z-50 group inset-y-0 xl:py-3.5 xl:pl-3.5 after:content-[''] after:fixed after:inset-0 after:bg-black/80 after:xl:hidden side-menu--collapsed [&.side-menu--mobile-menu-open]:ml-0 [&.side-menu--mobile-menu-open]:after:block -ml-[275px] after:hidden">
                    <div className="close-mobile-menu fixed ml-[275px] w-10 h-10 items-center justify-center xl:hidden z-50 [&.close-mobile-menu--mobile-menu-open]:flex hidden">
                        <a className="mt-5 ml-5" href="#" onClick={handleCloseMenu}>
                    ...
                    <div className="side-menu__content h-full box bg-white/[0.95] rounded-none xl:rounded-xl z-20 relative w-[275px] duration-300 transition-[width] group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:shadow-[6px_0_12px_-4px_#0000000f] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px] overflow-hidden flex flex-col">
                        <div className="flex-none hidden xl:flex items-center z-10 px-5 h-[65px] w-[275px] overflow-hidden relative duration-300 group-[.side-menu--collapsed]:xl:w-[91px] group-[.side-menu--collapsed.side-menu--on-hover]:xl:w-[275px]">
                            ...
                            <a className="toggle-compact-menu ml-auto hidden h-[20px] w-[20px] items-center justify-center rounded-full border border-slate-600/40 transition-[opacity,transform] hover:bg-slate-600/5 group-[.side-menu--collapsed]:xl:rotate-180 group-[.side-menu--collapsed.side-menu--on-hover]:xl:opacity-100 group-[.side-menu--collapsed]:xl:opacity-0 3xl:flex" href="#" onClick={handleToggleCompactMenu}>
                                <i data-tw-merge="" data-lucide="arrow-left" className="h-3.5 w-3.5 stroke-[1.3]"></i>
                            </a>
                        </div>
                            ...
                            <ul className="scrollable">
                                ...
                                <li>
                                    <a href="#" onClick={handleCloseMenu} className="side-menu__link ">
                                        <i data-tw-merge="" data-lucide="gauge-circle" className="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
                                ...
                                <li>
                                    <a href="#" onClick={handleCloseMenu} className="side-menu__link side-menu__link--active ">
                                        <i data-tw-merge="" data-lucide="activity-square" className="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
                                ...
                                <li>
                                    <a href="" className="side-menu__link ">
                                        <i data-tw-merge="" data-lucide="briefcase" className="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
                                ...
                                <li>
                                    <a href="#" onClick={HandleClick} className="side-menu__link ">
                                        <i data-tw-merge="" data-lucide="table2" className="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
                                        <div className="side-menu__link__title">Products</div>
                                        <i data-tw-merge="" data-lucide="chevron-down" className="stroke-[1] w-5 h-5 side-menu__link__chevron"></i>
                                    </a>
                                    
                                    <ul className="hidden">
                                        <li>
                                            <a href="#" onClick={HandleClick} className="side-menu__link ">
                                                <i data-tw-merge="" data-lucide="layout-panel-top" className="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
                                        ...
                                        <li>
                                            <a href="#" onClick={HandleClick} className="side-menu__link ">
                                                <i data-tw-merge="" data-lucide="layout-panel-left" className="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
                                                <div className="side-menu__link__title">
                                                    Product Grid
                                                </div>
                                            </a>
                                ...
                                <li>
                                    <a href="#" onClick={HandleClick} className="side-menu__link ">
                                        <i data-tw-merge="" data-lucide="tablet-smartphone" className="stroke-[1] w-5 h-5 side-menu__link__icon"></i>
