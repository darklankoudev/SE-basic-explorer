...
import { API_BASE_URL, API_BASE_URL_SUPPORT } from "../../constants/constants";
...
const Banner = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const res = await axios.get(`${API_BASE_URL}/chain/info`);
        const { total_transparent_txs, total_shielded_txs } = res.data;
        setInfo({ total_transparent_txs, total_shielded_txs });
      } catch (e) {
        console.log(e);
      }
